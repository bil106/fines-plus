...
class SubscriptionPlanCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final allFeatures = [
      S.of(context).access_basic,
      S.of(context).free_experience,
      S.of(context).premium_support,
    ];
        ...
        decoration: BoxDecoration(
          gradient: isSelected
              ? LinearGradient(
                  colors: [
                    AppColors.blue700,
                    AppColors.blue700.withOpacity(0.4),
                  ],
              ...
              Row(
                children: [
                  Icon(Icons.workspace_premium,
                      color: isSelected ? AppColors.blue700 : Colors.grey[600], size: 24),
