...
CarWashRecord _$CarWashRecordFromJson(Map<String, dynamic> json) => CarWashRecord(
...
Map<String, dynamic> _$CarWashRecordToJson(CarWashRecord instance) => <String, dynamic>{
