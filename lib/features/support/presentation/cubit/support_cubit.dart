  ...
  Future<void> openViber(String phoneNumber) async {
    ...
    if (await canLaunchUrl(uri)) {
      ...
      final fallbackUri = Uri.parse(
        'https://help.viber.com/hc/en-us/articles/8843920458653-Solutions-for-Rakuten-Viber-activation-and-registration-Issues?utm_campaign=version_unknown&utm_medium=Android&utm_source=Viber+App#sysid=1',
      );
